<x-app-layout title="Dashboard Admin">
    ...
    <div class="card my-4">
        <div class="card-header" style="background: #e9500e; color: #ffffff;">
            List Summary Question For Team {{ Auth::guard('admin')->user()->department }}
        </div>
        <div class="card-body">
            <x-alert />
                        ...
                        <tbody>
                            ...
                            @foreach ($departmentTotals as $departmentTotal)
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            href="{{ route('admin.summary.question.department', $departmentTotal['department']) }}">
                                            {{ $departmentTotal['department'] }}
                                        </a>
                                    </td>
                                    <td>{{ $departmentTotal['totalQuestion'] }}</td>
                                </tr>
                                @php
                                    $grandTotal += $departmentTotal['totalQuestion'];
                                @endphp
                            @endforeach
                        </tbody>
