<x-app-layout title="Dashboard Admin">
    ...
    <div class="card my-4">
        <div class="card-header" style="background: #e9500e; color: #ffffff;">
            List Summary Category "{{ $category }}"
        </div>
        <div class="card-body">
            <x-alert />
                    ...
                    <table class="table table-bordered" id="dataTable">
                        ...
                        <tbody>
                            @php
                                ...
                                $grandTotal = 0;
                            @endphp
                            @foreach ($totalResponsesPerQuestion as $question => $totalResponses)
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td><a
                                            href="{{ route('admin.summary.response.question', $question) }}">{{ $question }}</a>
                                    </td>
